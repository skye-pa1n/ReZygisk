...
namespace SoList  {
  ...
  static bool Initialize() {
    ...
    */
    ...
    SoInfo::get_realpath_sym = reinterpret_cast<decltype(SoInfo::get_realpath_sym)>(linker.getSymbAddress(get_realpath_sym_name));
    SoInfo::get_soname_sym = reinterpret_cast<decltype(SoInfo::get_soname_sym)>(linker.getSymbAddress(get_soname_sym_name));
